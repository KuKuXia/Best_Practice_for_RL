...
export LD_LIBRARY_PATH=$VREP_ROOT:$LD_LIBRARY_PATH
...
```bash
LD_LIBRARY_PATH=/home/longxiajun/MySoftware/CoppeliaSim/;VREP_ROOT=/home/longxiajun/MySoftware/CoppeliaSim/
```
